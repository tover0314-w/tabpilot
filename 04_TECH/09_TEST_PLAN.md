...
- DeepSeek metadata-only Agent output filters invented tab IDs, rejects unknown/destructive action types, renders optional relevant tabs and safe action chips, and does not apply browser actions automatically
