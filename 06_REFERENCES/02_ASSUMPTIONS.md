...
1. MV3 + action.onClicked + sidePanel.open 可以支持主流程。
2. 不设置 default_popup 是正确主入口设计。
...
3. 用户自配 DeepSeek/OpenAI-compatible API key 可降低早期 AI 成本。
4. Hosted AI 是 Pro 体验的关键。
5. Lifetime deal 可作为早期 indie 增长策略。
